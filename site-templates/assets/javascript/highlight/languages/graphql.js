    ...
    var e = (() => {
        "use strict"; return e => {
            const n = e.regex, a = /[\p{XID_Start}_]\p{XID_Continue}*/u, i = {
                ...
                keyword: ["query", "mutation", "subscription", "async", "await", "break", "class", "continue", "def", "del", "elif", "else", "except", "finally", "for", "from", "global", "if", "import", "in", "is", "lambda", "nonlocal|10", "not", "or", "pass", "raise", "return", "try", "while", "with", "yield"],
                ...
                className: "string", contains: [e.BACKSLASH_ESCAPE], variants: [{
                    ...
                    end: /"""/, contains: [e.BACKSLASH_ESCAPE, s, r, t]
                }, {
                    begin: /([uU]|[rR])'/, end: /'/,
                    relevance: 10
                ...
                illegal: /(<\/|->|\?)|=>/, contains: [s, c, { begin: /\bself\b/ }, {
                    beginKeywords: "if",
                    relevance: 0
